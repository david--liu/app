...
namespace app.web.core
{
    public class RequestProcessorRegistry : IFindRequestProcessors
    {
        ...
        CreateMissingRequestProcessor_Behaviour the_special_case;

        public RequestProcessorRegistry(IEnumerable<IProcessOneRequest> all_the_possible_processors, CreateMissingRequestProcessor_Behaviour the_special_case)
        {
        ...
        public IProcessOneRequest get_the_command_that_can_handle(IContainRequestDetails the_request)
        {
            ...
            return process_one_request ?? the_special_case.Invoke(); 
        }
    }
}
